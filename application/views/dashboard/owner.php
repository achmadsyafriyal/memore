  					...
  					<div class="d-flex flex-column" id="content-wrapper">
						...
						<!-- <div class="d-flex flex-column" id="content-wrapper"> -->
  							<!-- <div class="container-fluid"> -->
								  ...
								  ?>
  									<div class="col-md-6 col-xl-4 mb-4">
  										<div class="card shadow border-left-info bg-white py-5">
  											<div class="card-body">
  												<div class="row align-items-center no-gutters">
  													<div class="col mr-2">
  														<div class="text-uppercase text-dark font-weight-bold text-xs mb-1"><span><?php echo $pt->profit_nama, '';?></span></div>
  														<div class="text-dark font-weight-bold h5 mb-0"><span>         
														<?php $a=($jumlahpemasukan-$jumlahpengeluaran)*$pt->profit_nilai/100;
														echo rupiah($a)?></span></div>
  													</div>
  													<div class="col-auto"><i class="fas fa-money-check fa-2x"></i></div>
  												</div>
  											</div>
  										</div>
  									</div>
								<?php 
  									...
  									<!-- <div class="col-md-6 col-xl-4 mb-4">
  										<div class="card shadow bg-warning py-5">
  											<div class="card-body">
  												<div class="row align-items-center no-gutters">
  													<div class="col mr-2">
  														<div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Uang Masuk</span></div>
									  ...
									  <div class="col-md-6 col-xl-4 mb-4">
  										<div class="card shadow bg-success py-5">
  											<div class="card-body">
  												<div class="row align-items-center no-gutters">
  													<div class="col mr-2">
  														<div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Uang Masuk</span></div>
